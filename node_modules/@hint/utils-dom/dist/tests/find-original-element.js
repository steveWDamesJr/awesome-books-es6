...
const compare = (originalSource, snapshotSource) => {
    const originalDocument = src_1.createHTMLDocument(originalSource, 'http://example.com');
    const snapshotDocument = src_1.createHTMLDocument(snapshotSource, 'http://example.com');
    ...
    const foundElement = src_1.findOriginalElement(originalDocument, snapshotElement);
...
ava_1.default('Find by URL match (src)', (t) => {
...
ava_1.default('Find by URL no match (src)', (t) => {
    const result = compare(`
            <img src="test1.png">
        `, `
            <img src="test1.png">
...
ava_1.default('Find by nth URL match (src)', (t) => {
    const result = compare(`
            <img src="test2.png">
            <img data-original src="test2.png">
        `, `
...
ava_1.default('Find by URL match (href)', (t) => {
    const result = compare(`
...
ava_1.default('Find by content match (script)', (t) => {
    const result = compare(`
...
ava_1.default('Find by URL or content no match (script)', (t) => {
    const result = compare(`
...
ava_1.default('Find by nth content match (button)', (t) => {
    const result = compare(`
            <button>OK</button>
...
ava_1.default('Find by first class match (div)', (t) => {
    const result = compare(`
...
ava_1.default('Find by first class no match (div)', (t) => {
    const result = compare(`
            <div class="first">Test</div>
        `, `
            <div class="first">Test</div>
...
ava_1.default('Find by singleton match (html)', (t) => {
    const result = compare(`
            <html data-original>
                Test
            </html>
...
ava_1.default('Find by nth match (tr)', (t) => {
    const result = compare(`
            <table>
                <tr><td>Data</td></tr>
...
ava_1.default('Find by nth no match (tr)', (t) => {
    const result = compare(`
            <table>
                <tr><td>Data</td></tr>
                <tr><td>Data</td></tr>
